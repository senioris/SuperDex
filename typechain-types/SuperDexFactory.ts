...
export interface SuperDexFactoryInterface extends Interface {
...
export interface SuperDexFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SuperDexFactory;
  waitForDeployment(): Promise<this>;

  interface: SuperDexFactoryInterface;
